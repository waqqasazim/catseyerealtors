                        ...
                        <div class="ul-service-details-sidebar">
                            <div class="ul-service-details-sidebar-widget overflow-hidden">
                                ...
                                <ul class="service-list">
                                    <li><a href="service-details.php">Illustration Design <i class="flaticon-read-more-icon"></i></a></li>
                                    <li><a href="service-details.php">Business Branding <i class="flaticon-read-more-icon"></i></a></li>
                                    <li><a href="service-details.php">Packaging Design <i class="flaticon-read-more-icon"></i></a></li>
                                    <li><a href="service-details.php" class="current">Mobile Apps Design <i class="flaticon-read-more-icon"></i></a></li>
                                    <li><a href="service-details.php">Web UI/UX Design <i class="flaticon-read-more-icon"></i></a></li>
                                    <li><a href="service-details.php">Application Design <i class="flaticon-read-more-icon"></i></a></li>
                                </ul>
                            </div>
