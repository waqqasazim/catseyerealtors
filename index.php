                                ...
                                <div class="ul-project-txt">
                                    ...
                                    <div class="top">
                                        <div class="left">
                                            ...
                                            <a href="project-details.php" class="ul-project-title">Faulkner Ave</a>
                            ...
                            <div class="ul-project">
                                ...
                                <div class="ul-project-txt">
                                    ...
                                    <div class="top">
                                        <div class="left">
                                            <span class="ul-project-price"><span class="number">$4,500</span>/Month</span>
                                            <a href="project-details.php" class="ul-project-title">Palm Harbor</a>
                                            <p class="ul-project-location">2821 Lake Sevilla, Palm Harbor, TX</p>
                                        </div>
                                        <div class="right">
                                            <button class="ul-project-add-to-favorites-btn"><i class="flaticon-heart"></i></button>
                            ...
                            <div class="ul-project">
                                ...
                                <div class="ul-project-txt">
                                    ...
                                    <div class="top">
                                        <div class="left">
                                            <span class="ul-project-price"><span class="number">$4,500</span>/Month</span>
                                            <a href="project-details.php" class="ul-project-title">St. Crystal</a>
                                            <p class="ul-project-location">2821 Lake Sevilla, Palm Harbor, TX</p>
                                        </div>
                                        <div class="right">
                                            <button class="ul-project-add-to-favorites-btn"><i class="flaticon-heart"></i></button>
                                ...
                                <div class="ul-banner-container">
                                    <div class="row align-items-center flex-sm-row flex-column-reverse">
                                        ...
                                        <div class="col-md-9 col-sm-8">
                                            <span class="ul-banner-slide-shadow-title">CATSEYE</span>
                                            <div class="ul-banner-slide-txt wow animate__fadeInUp">
                                                <span class="ul-banner-slide-sub-title">your Luxury Residence</span>
                                                <h1 class="ul-banner-slide-title">Let's find your dream property</h1>
                                                ...
                                                <div class="ul-banner-slide-btns">
                                                    <a href="projects.php" class="ul-btn">Explore Properties</a>
                                                </div> -->
                                            </div>
                                        </div>

                                        <section class="ul-property-filter-search">
                                                ...
                                                <form action="#" class="ul-property-filter-search-form wow animate__fadeInUp">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="location" id="filter-location">
                                                            ...
                                                            <option value="los-angeles">All Cities</option>
                                                            <option value="new-york">Noida</option>
                                                            <option value="san-francisco">Delhi</option>
                                                            <option value="san-diego">Gurugram</option>
                                                            <option value="san-jose">Ghaziabad</option>
                                                            <option value="san-bernardino">Mumbai</option>
                                                            <option value="san-bernardino">Bengaluru</option>
                                                            <option value="san-bernardino">Pune</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <option style="display: none;" value="">Price Range</option>
                                                            <option value="200-500">UpTo 70 L</option>
                                                            <option value="500-1000">70 L - 1 Cr</option>
                                                            <option value="1000-1500">1 Cr - 3 Cr</option>
                                                            <option value="1000-1500">3 Cr - 5 Cr</option>
                                                            <option value="1000-1500">Above 5 Cr</option>
                                                        </select>
                                                    </div>
        ...
        <section class="ul-cities ul-section-spacing">
            <div class="ul-container wow animate__fadeInUp">
                ...
                <div class="ul-section-heading">
                    <div class="left">
                        <h2 class="ul-section-title">Properties</h2>
                        <p class="ul-section-descr">Listed below are the best properties across India curated only for you.</p>
                    </div>
                    <div class="right">
                        <a href="projects.php" class="ul-btn">See All Properties</a>
                    </div>
                </div>
                ...
                <div class="row row-cols-xl-4 row-cols-md-3 row-cols-2 row-cols-xxs-1 g-4 mx-auto">
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-1.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Noida</a></h3>
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-2.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Delhi</a></h3>
                                <span class="ul-city-count">15 Properties</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-3.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Gurugram</a></h3>
                                <span class="ul-city-count">15 Properties</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-4.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Ghaziabad</a></h3>
                                <span class="ul-city-count">15 Properties</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-5.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Mumbai</a></h3>
                                <span class="ul-city-count">15 Properties</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-6.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Columbus</a></h3>
                                <span class="ul-city-count">15 Properties</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-7.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Bengaluru</a></h3>
                                <span class="ul-city-count">15 Properties</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-8.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Pune</a></h3>
                                <span class="ul-city-count">15 Properties</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="ul-city">
                            <div class="img"><a href="projects.php"><img src="assets/img/city-8.jpg" alt="City Image"></a></div>
                            <div class="txt">
                                <h3 class="ul-city-title"><a href="projects.php">Dubai</a></h3>
                                <span class="ul-city-count">15 Properties</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="ul-featured-property ul-project">
                                <div>
                                    ...
                                    <a href="project-details.php" class="ul-project-title">Cove Red</a>
                                    <p class="ul-project-location">2821 Lake Sevilla, Palm Harbor, TX</p>
                                </div>
                                <div class="ul-project-img">
                        ...
                        <div class="swiper-slide">
                            <div class="ul-featured-property ul-project">
                                <div>
                                    ...
                                    <a href="project-details.php" class="ul-project-title">Tarpon Bay</a>
                                    <p class="ul-project-location">2821 Lake Sevilla, Palm Harbor, TX</p>
                                </div>
                                <div class="ul-project-img">
                        ...
                        <div class="swiper-slide">
                            <div class="ul-featured-property ul-project">
                                <div>
                                    ...
                                    <a href="project-details.php" class="ul-project-title">Beverly Springfield</a>
                                    <p class="ul-project-location">2821 Lake Sevilla, Palm Harbor, TX</p>
                                </div>
                                <div class="ul-project-img">
        ...
        <section class="ul-properties ul-section-spacing">
            <div class="ul-container">
                ...
                <div class="text-center wow animate__fadeInUp">
                    <a href="projects.php" class="ul-btn ul-properties-btn">Browse More Properties</a>
                </div>
            </div>
        </section>
        ...
        <section class="ul-blogs ul-section-spacing">
            <div class="ul-container wow animate__fadeInUp">
                ...
                <div class="ul-section-heading">
                    ...
                    <div class="right">
                        <a href="blog.php" class="ul-btn ul-blogs-heading-btn">View All News</a>
                    </div>
                </div>
                        ...
                        <div class="ul-blog-wrapper">
                            <div class="ul-blog">
                                ...
                                <div class="ul-blog-txt">
                                    ...
                                    <a href="blog-details.php" class="ul-blog-title">What to Look for When Buying a Pre-Owned Car Cars Which is Right for You</a>
                                    ...
                                    <a href="blog-details.php" class="ul-blog-btn">Read More <span class="icon"><i class="flaticon-aro-left"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ul-blog-wrapper">
                            <div class="ul-blog ul-blog-horizontal">
                                ...
                                <div class="ul-blog-txt">
                                    ...
                                    <a href="blog-details.php" class="ul-blog-title">What to Look for When Buying a</a>
            ...
            <div class="ul-container">
                <div class="ul-footer-top-wrapper wow animate__fadeInUp">
                    ...
                    <div class="ul-footer-about">
                        <a href="index.php"><img src="assets/img/logo-dark.svg" alt="logo"></a>
                        <p class="ul-footer-about-txt">over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
