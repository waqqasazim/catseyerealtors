            ...
            <section class="ul-specialities overflow-hidden">
                <div class="ul-specialities-heading-card wow animate__fadeInUp">
                    <div class="txt">
                        ...
                        <a href="projects.php" class="ul-btn">Browse Properties</a>
                    </div>
                    ...
                    <div class="row ul-bs-row row-cols-md-3 row-cols-2 row-cols-xxs-1">
                        ...
                        <div class="col">
                            <div class="ul-service">
                                ...
                                <a href="service-details.php" class="ul-service-title">Buy a Home</a>
                                ...
                                <a href="service-details.php" class="ul-service-btn">Find a Home <i class="flaticon-aro-left"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="ul-service">
                                ...
                                <a href="service-details.php" class="ul-service-title">Rent a Home</a>
                                <p class="ul-service-descr">over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
                                <a href="service-details.php" class="ul-service-btn">Find a Home <i class="flaticon-aro-left"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="ul-service">
                                ...
                                <a href="service-details.php" class="ul-service-title">Buy a Home</a>
                                <p class="ul-service-descr">over 1 million+ homes for sale available on the website, we can match you with a house you will want to call home.</p>
                                <a href="service-details.php" class="ul-service-btn">Sell a Home <i class="flaticon-aro-left"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
